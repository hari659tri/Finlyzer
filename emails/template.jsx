        ...
        <Body style={styles.body}>
          <Container style={styles.container}>
            ...
            {data?.insights && Array.isArray(data.insights) && (
              <Section style={styles.section}>
                <Heading style={styles.heading}>Personal Finance Visualizer Insights</Heading>
            ...
            <Text style={styles.footer}>
              Thank you for using Personal Finance Visualizer. Keep tracking your finances for better
              financial health!
            </Text>
          </Container>
        </Body>
